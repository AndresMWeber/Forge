...
# version = __import__('maya_signatures').__version__
# The full version, including alpha/beta/rc tags.
# release = __import__('maya_signatures').__version__
...
latex_documents = [
    (master_doc, 'forge.tex', u'forge Documentation',
